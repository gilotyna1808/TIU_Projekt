...
namespace WebApiKonie.Models
{
    public class ZakladyDB:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename='C:\Users\Mateusz\Source\Repos\TIU_Projektv2\WebApiKonie\WebApiKonie\Baza.mdf';Integrated Security=True;
